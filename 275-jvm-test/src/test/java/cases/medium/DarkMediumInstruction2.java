...
public class DarkMediumInstruction2 {
    ...
    //Areturn
    public DarkMediumInstruction2 retObject(int a) {
        if (a > 0) {
            return new DarkMediumInstruction2();
        } else {
            return new DarkMediumInstruction2();
        }
    }
    ...
    public void testReturn() {
        DarkMediumInstruction2 test = retObject(3);
    ...
    public void testNull(DarkMediumInstruction2 test1, DarkMediumInstruction2 test2) {
    ...
    public static void main(String[] args) {
        DarkMediumInstruction2 tester = new DarkMediumInstruction2();
        int ret = tester.run();
        if (!tester.fail) {
            tester.testAdd();
            ret = tester.result;
